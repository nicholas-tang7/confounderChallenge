...
ax.scatter(dreamy_data['patient'], dreamy_data['post_surgical_score'],
           ...
           label='Doc Dreamy', edgecolors='#4E79A7', linewidths=0.5)

ax.scatter(duck_data['patient'], duck_data['post_surgical_score'],
           marker='^', color='#E15759', s=60, alpha=0.7,
           label='Doc Duck', edgecolors='#E15759', linewidths=0.5)

# Add horizontal dashed lines for means
ax.axhline(y=dreamy_mean, color='#4E79A7', linestyle='--', linewidth=2, alpha=0.8)
ax.axhline(y=duck_mean, color='#E15759', linestyle='--', linewidth=2, alpha=0.8)
...
ax.text(x_max - x_range * 0.02, dreamy_mean, f'o {dreamy_mean:.2f}',
        ha='right', va='center', fontsize=11, color='#4E79A7',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#4E79A7'))

ax.text(x_max - x_range * 0.02, duck_mean, f'A {duck_mean:.2f}',
        ha='right', va='center', fontsize=11, color='#E15759',
...
ax.set_title('Post-Surgical Symptom Score by Patient and Doctor', fontsize=15, fontweight='bold', pad=15)
...
dreamy_data <- patients_df %>% filter(doctor_name == "Doc Dreamy")
duck_data <- patients_df %>% filter(doctor_name == "Doc Duck")
...
ggplot(patients_df, aes(x = patient, y = post_surgical_score, color = doctor_name, shape = doctor_name)) +
  # Add scatter points with different shapes and colors
  ...
  annotate(
    "text",
    x = max(patients_df$patient) * 0.98,
    y = dreamy_mean,
    label = paste0("o ", round(dreamy_mean, 2)),
    color = "#4E79A7",
    size = 3.5,
    hjust = 1,
    vjust = 0.5,
  ...
  annotate(
    ...
    x = max(patients_df$patient) * 0.98,
    y = duck_mean,
    label = paste0("A ", round(duck_mean, 2)),
    color = "#E15759",
    size = 3.5,
    hjust = 1,
    vjust = 0.5,
  ...
  # Shape mapping: circles for Doc Dreamy, triangles for Doc Duck
  scale_shape_manual(
...
# Add horizontal dashed lines for means
ax.axhline(y=dreamy_mean_randomized, color='#4E79A7', linestyle='--', linewidth=2, alpha=0.8)
ax.axhline(y=duck_mean_randomized, color='#E15759', linestyle='--', linewidth=2, alpha=0.8)
...
# Add text annotations with shape symbols
ax.text(x_max - x_range * 0.02, dreamy_mean_randomized, f'o {dreamy_mean_randomized:.2f}',
        ha='right', va='center', fontsize=11, color='#4E79A7',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#4E79A7'))

ax.text(x_max - x_range * 0.02, duck_mean_randomized, f'A {duck_mean_randomized:.2f}',
        ha='right', va='center', fontsize=11, color='#E15759',
        bbox=dict(boxstyle='round,pad=0.3', facecolor='white', alpha=0.8, edgecolor='#E15759'))
...
ax.set_xlabel('Patient Number', fontsize=13, fontweight='bold')
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=13, fontweight='bold')
ax.set_title('Post-Surgical Symptom Score (Randomized Assignment)', fontsize=15, fontweight='bold', pad=15)
ax.grid(True, alpha=0.3, linestyle='-', linewidth=0.5)
ax.legend(loc='upper right', fontsize=11, framealpha=0.9)
...
# Separate data by doctor and calculate means
dreamy_data_randomized <- patients_randomized_df %>% filter(doctor_name == "Doc Dreamy")
duck_data_randomized <- patients_randomized_df %>% filter(doctor_name == "Doc Duck")

dreamy_mean_randomized <- mean(dreamy_data_randomized$post_surgical_score)
duck_mean_randomized <- mean(duck_data_randomized$post_surgical_score)
...
ggplot(patients_randomized_df, aes(x = patient, y = post_surgical_score, color = doctor_name, shape = doctor_name)) +
  ...
  # Add horizontal dashed lines for means
  geom_hline(
    yintercept = dreamy_mean_randomized,
    color = "#4E79A7",
    linetype = "dashed",
    linewidth = 1,
    alpha = 0.8
  ...
  geom_hline(
    yintercept = duck_mean_randomized,
    color = "#E15759",
    linetype = "dashed",
    linewidth = 1,
    alpha = 0.8
  ...
  annotate(
    "text",
    x = max(patients_randomized_df$patient) * 0.98,
    y = dreamy_mean_randomized,
    label = paste0("o ", round(dreamy_mean_randomized, 2)),
    color = "#4E79A7",
    size = 3.5,
    hjust = 1,
    vjust = 0.5,
  ...
  annotate(
    "text",
    x = max(patients_randomized_df$patient) * 0.98,
    y = duck_mean_randomized,
    label = paste0("A ", round(duck_mean_randomized, 2)),
    color = "#E15759",
    size = 3.5,
    hjust = 1,
    vjust = 0.5,
...
# Add shaded rectangular overlay for severity between -1 and 1
ax.axvspan(-1, 1, alpha=0.15, color='gray', zorder=0)

# Plot scatter points
ax.scatter(dreamy_data['severity'], dreamy_data['post_surgical_score'],
           marker='o', color='#4E79A7', s=60, alpha=0.7, 
           label='Doc Dreamy', edgecolors='#4E79A7', linewidths=0.5, zorder=2)

ax.scatter(duck_data['severity'], duck_data['post_surgical_score'],
           marker='^', color='#E15759', s=60, alpha=0.7,
           label='Doc Duck', edgecolors='#E15759', linewidths=0.5, zorder=2)

# Add horizontal dashed lines for means
ax.axhline(y=dreamy_mean, color='#4E79A7', linestyle='--', linewidth=2, alpha=0.8, zorder=1)
ax.axhline(y=duck_mean, color='#E15759', linestyle='--', linewidth=2, alpha=0.8, zorder=1)

# Get axis limits for annotation positioning
...
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=13, fontweight='bold')
ax.set_title('Post-Surgical Symptom Score by Patient Severity', fontsize=15, fontweight='bold', pad=15)
...
ggplot(patients_df, aes(x = severity, y = post_surgical_score, color = doctor_name, shape = doctor_name)) +
  ...
  annotate(
    "text",
    x = max(patients_df$severity) * 0.98,
    y = dreamy_mean,
    label = paste0("o ", round(dreamy_mean, 2)),
    color = "#4E79A7",
    size = 3.5,
